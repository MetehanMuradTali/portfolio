...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('metehanmuradtali@gmail.com');
        setHasCopied(true);
        setTimeout(() => {
            setHasCopied(false);
        },
                    ...
                    <div className='grid-container'>
                        <div className='rounded-3xl w-full sm:h-[326px] h-fit flex justify-center items-center'>
                            <Globe
                                ...
                                labelsData={[{ lat: 39.1667, lng: 35.6667, text: "I'm Located Here", color: 'white', size: 40 }]} />
                        </div>
                        <div>
                            <p className='grid-headtext'>I work remotely across most timezones</p>
                            <p className='grid-subtext'>I live in Turkey, with remote work available.</p>
